            ...
            modelBuilder.Entity("Artalex.DAL.Models.AuditQuestionPotentialGround", b =>
                {
                    ...
                    b.ToTable("audit_question_potential_grounds", (string)null);
                });
            ...
            modelBuilder.Entity("Artalex.DAL.Models.AuditResponse", b =>
                {
                    ...
                    b.Property<long>("AuditQuestionPotentialGroundId")
                        .HasColumnType("bigint")
                        .HasColumnName("audit_question_potential_ground_id");
                    ...
                    b.HasIndex("AuditQuestionPotentialGroundId")
                        .HasDatabaseName("ix_audit_responses_audit_question_potential_ground_id");
            ...
            modelBuilder.Entity("Artalex.DAL.Models.AuditQuestionPotentialGround", b =>
                {
                    b.HasOne("Artalex.DAL.Models.AuditQuestion", "AuditQuestion")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_audit_question_potential_grounds_audit_questions_audit_quest");
            ...
            modelBuilder.Entity("Artalex.DAL.Models.AuditResponse", b =>
                {
                    ...
                    b.HasOne("Artalex.DAL.Models.AuditQuestionPotentialGround", "AuditQuestionPotentialGround")
                        .WithMany()
                        .HasForeignKey("AuditQuestionPotentialGroundId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_audit_responses_audit_question_potential_grounds_audit_ques");
                    ...
                    b.HasOne("Artalex.DAL.Models.AuditResponseAssignedTo", "AuditResponseAssignedTo")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_audit_responses_audit_response_assigned_tos_audit_response_");
                    ...
                    b.HasOne("Artalex.DAL.Models.AuditResponsePotentialGround", "AuditResponsePotentialGround")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_audit_responses_audit_response_potential_grounds_audit_resp");
                    ...
                    b.HasOne("Artalex.DAL.Models.AuditResponseStatus", "AuditResponseStatus")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_audit_responses_audit_response_status_audit_response_status");
