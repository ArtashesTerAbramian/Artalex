...
namespace Artalex.DAL.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "audit_question_potential_grounds",
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_audit_question_potential_grounds_audit_questions_audit_quest",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    audit_response_potential_ground_id = table.Column<long>(type: "bigint", nullable: true),
                    audit_response_question_potential_ground_id = table.Column<long>(type: "bigint", nullable: true),
                    audit_question_potential_ground_id = table.Column<long>(type: "bigint", nullable: false),
                    response_text = table.Column<string>(type: "text", nullable: false),
                    audit_id = table.Column<long>(type: "bigint", nullable: false),
                    audit_question_id = table.Column<long>(type: "bigint", nullable: false),
                    created_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_audit_responses_audit_question_potential_grounds_audit_ques",
                        column: x => x.audit_question_potential_ground_id,
                        principalTable: "audit_question_potential_grounds",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_audit_responses_audit_response_assigned_tos_audit_response_",
                        column: x => x.audit_response_assigned_to_id,
                        principalTable: "AuditResponseAssignedTos",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_audit_responses_audit_response_potential_grounds_audit_resp",
                        column: x => x.audit_response_potential_ground_id,
                        principalTable: "AuditResponsePotentialGrounds",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_audit_responses_audit_response_status_audit_response_status",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "audit_responses",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "audit_question_potential_grounds",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_audit_responses_audit_question_potential_ground_id",
                table: "audit_responses",
                column: "audit_question_potential_ground_id");
